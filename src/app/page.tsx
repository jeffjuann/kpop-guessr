...
export default async function Page()
{
  ...
  const answerId: ObjectId = (await serverClient.getAnswerId())[0]._id.toString(); 

  return (
    <div className="w-full h-full pt-12 flex flex-col gap-12 items-center justify-start">
